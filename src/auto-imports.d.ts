...
declare global {
  ...
  const didWin: typeof import('./state')['didWin']
  ...
  const movesAvailable: typeof import('./state')['movesAvailable']
  const nextTurn: typeof import('./state')['nextTurn']
  const noMoreMoves: typeof import('./state')['noMoreMoves']
  ...
  const resetState: typeof import('./state')['resetState']
  const setState: typeof import('./state')['setState']
  const splitProps: typeof import('solid-js')['splitProps']
  const state: typeof import('./state')['state']
  ...
  const winnerInfo: typeof import('./state')['winnerInfo']
}
